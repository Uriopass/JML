 ...
 */
public class Matrix {
	// Axe des lignes, utilis� pour effectuer une somme sur un seul axe par exemple
	...
	/**
	 * Cr�e une matrice remplie de z�ros
	 * 
	 * @param width
	 *            nombre de colonnes
	 * @param height
	...
	/**
	 * Cr�e une copie de la matrice pass�e en argument
	 * 
	 * @param x
	 *            Matrice � copier
	 */
	...
	/**
	 * Effectue une addition de deux matrices, �l�ment-�-�lement.
	 * 
	 * @param a
	 *            Premi�re matrice � additionner
	 * @param b
	 *            Deuxi�me matrice � additionner
	...
	/**
	 * Ajoute � tout les �lements de cette matrice un scalaire
	 * 
	 * @param value
	 *            scalaire � ajouter
	 * @return this
	...
	/**
	 * Additionne une matrice � cette matrice, �l�ment-�-�lement
	 * 
	 * @param b
	 *            Matrice � additionner
	 * @return this
	 ...
	 * @param axis
	 *            axe � utiliser
	 * @return vecteur contenant les r�sultats
	 */
	...
	/**
	 * V�rifie si cette matrice est �gal � une autre matrice avec une pr�cision
	 * 1e-10
	 */
	@Override
	...
	/**
	 * Permet de r�cuperer une colonne de la matrice sous la forme d'un vecteur
	 * 
	 * @param i
	...
	/**
	 * Permet de r�cuperer une ligne de la matrice sous la forme d'un vecteur
	 * 
	 * @param j
	...
	/**
	 * Effectue une multiplication �l�ment-�-�lement de de la matrice actuelle avec
	 * la nouvelle matrice La multiplication se fait en-place, une nouvelle matrice
	 * n'est donc pas allou�e
	 * 
	 * @param b
	 *            matrice � multiplier
	 * @return this
	...
	/**
	 * Effectue une multiplication �l�ment-�-�lement de deux matrices
	 * 
	 * @param a
	 *            Premi�re matrice � multiplier
	 * @param b
	 *            Deuxi�me matrice � multiplier
	...
	/**
	 * Renvoie la norme L2 de cette matrice, d�finie par sqrt(somme(x_ij*x_ij))
	 */
	...
	/**
	 * Affiche les valeurs de cette matrice, avec une pr�cision de 3 chiffres
	 */
	...
	/**
	 * Multiplie tout les �lements de cette matrice par un scalaire
	 * 
	 * @param value
	 *            scalaire � multiplier
	 * @return this
	...
	/**
	 * Multiplie tout les �lements d'une matrice par un scalaire
	 * 
	 * @param value
	 *            scalaire utilis�
	 * @param m
	 *            Matrice � multiplier
	 * @return nouvelle matrice contenant le r�sultat
	 */
	 ...
	 * @param axis
	 *            axe � utiliser
	 * @return vecteur contenant les r�sultats de chaque somme
	 */
	...
	/**
	 * Renvoie la transpos�e de la matrice
	 * 
	...
	/**
	 * Renvoie la transpos�e d'une matrice m
	 * 
	 * @param m
	 *            Matrice � transposer
	 * @return transpos�e de la matrice
	 ...
	 * que chaque �l�ment en hauteur est un filtre, et en mettant ces filtres les
	 * uns � c�t� des autres.
	 * 
	 * @param name
	 *            nom du fichier � utiliser pour l'�criture
	 * @param dimension
	...
	/**
	 * pad une matrice avec des z�ros
	 * 
	 * @param pad
	 *            taille du pad
	 */
